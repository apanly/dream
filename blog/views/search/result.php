    ...
    <?php if($page_info['total_page']):?>
        <nav class="pagination" role="navigation">
            <?php if($page_info['previous']):?>
                <a class="newer-posts" href="<?=$urls['page_base']."&p=".($page_info['current']-1);?>"><i class="fa fa-angle-left"></i></a>
            <?php endif;?>
            <span class="page-number">第 <?=$page_info['current'];?> 页 &frasl; 共 <?=$page_info['total_page'];?> 页</span>
            <?php if($page_info['next']):?>
                <a class="older-posts" href="<?=$urls['page_base']."&p=".($page_info['current'] + 1);?>"><i class="fa fa-angle-right"></i></a>
            <?php endif;?>
        </nav>
    <?php endif;?>
