				...
				<?php foreach( $data as $_item ):?>
                    <li class="index-article-item ">
                        ...
                        <div class="article-item-text">
                            <a class="article-item-title" href="<?=GlobalUrlService::buildSuperMarketUrl("/default/info",[ "id" => $_item['id'] ]);?>"><h1><?=DataHelper::encode( $_item['title'] );?></h1></a>
        ...
        <section class="paginator-element">
            <ul class="pagination">
				<?php if( $page_info['previous'] ):?>
                    <li><a href="<?=GlobalUrlService::buildSuperMarketUrl("/default/mina",[ "p" => 1 ]);?>" rel="prev">上一页</a></li>
				<?php endif;?>
				<?php for( $page_idx = $page_info['from']; $page_idx <= $page_info['end'];$page_idx++):?>
					...
					<?php else:?>
                        <li><a href="<?=GlobalUrlService::buildSuperMarketUrl("/default/mina",[ "p" => $page_idx ]);?>"><?=$page_idx;?></a></li>
					<?php endif;?>
				<?php endfor;?>
				<?php if( $page_info['next'] ):?>
                    <li>
                        <a href="<?=GlobalUrlService::buildSuperMarketUrl("/default/mina",[ "p" => $page_info['current'] + 1 ]);?>" rel="next">下一页</a>
                    </li>
				<?php endif;?>
            </ul>
        </section>
