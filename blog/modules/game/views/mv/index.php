...
<div class="am-g">
    <div class="am-u-lg-12 am-u-md-12 am-u-sm-12">
        <div class="am-btn-toolbar"  style="padding: 0 16px;">
            <?php if( $urls['has_pre'] ):?>
                <a href="<?=UrlService::buildGameUrl("/mv/index",['p' => ($p-1)]);?>" class="am-btn am-btn-primary am-fl">上一组</a>
            <?php else:?>
                <a href="javascript:void(0);" class="am-btn am-btn-default am-fl">上一组</a>
            <?php endif;?>

            <?php if( $urls['has_next'] ):?>
                <a href="<?=UrlService::buildGameUrl("/mv/index",['p' => ($p+1)]);?>" class="am-btn am-btn-primary am-fr">下一组</a>
            <?php else:?>
