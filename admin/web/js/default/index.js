...
var default_index_ops = {
    ...
    drawCharts:function(){
        var that = this;
        $.ajax({
            url: common_ops.buildAdminUrl("/charts/dashboard"),
            data: {
            ...
            success: function (res) {
                var data = res.data ;
                chart_ops.drawPie( { 'title':'操作系统', 'target':'client_os_chart', 'series':data.client_os.series} );
                ...
                chart_ops.drawPie( {'title':'设备', 'target':'client_device_chart', 'series':data.client_device.series});
            }
        });
