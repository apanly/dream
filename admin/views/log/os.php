...
<div class="row">
    <div class="row-in">
        <div class="columns-24">
			<?php echo \Yii::$app->view->renderFile("@admin/views/common/stat_tab.php", ['current' => 'os']); ?>
        </div>
    </div>
</div>
<div class="row">
				...
				<?php if($data):?>
					<?php foreach($data as $_item):?>
                        <tr>
                            ...
                            <td><?=$_item['date'];?> </td>
                            <td>
                                <a class="color-theme" target="_blank" href="<?=AdminUrlService::buildUrl("/log/access",[ 'client_os' => $_item['client_os'] ]);?>">
									<?=$_item['client_os'];?>
                                </a>
                            </td>
